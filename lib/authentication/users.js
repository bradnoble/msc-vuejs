...
let users = [
    { id: 1, username: 'member', password: 'MadRiver2018!', roles: 'user', token: '14344b97-3f75-40d9-8786-bb7a55ec9d7f' },
    { id: 2, username: 'admin', password: 'Paradise@1947', roles: 'admin', token: 'e831c0d2-d0fa-41ca-95f6-fab8dccfc83b' }
];
